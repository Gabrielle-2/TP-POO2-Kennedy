...
public class ShowOrdi extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        retourButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                // Action de retour : on revient à l'écran principal
    ...
    private HBox createAnnonceBox(String ordinateur) {
        ...
        signalerButton.setStyle("-fx-font-size: 14px; -fx-background-color: #d32f2f; -fx-text-fill: white; -fx-border-radius: 8px; -fx-padding: 10px;");
        ...
        hbox.setBackground(new Background(new BackgroundFill(Color.web("#ede7f6"), new CornerRadii(15), Insets.EMPTY))); // Fond violet doux
        hbox.setBorder(new Border(new BorderStroke(
                Color.web("#00008B"), // Bordure violet foncé
